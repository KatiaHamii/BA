...
def main():
    ...
    words1 = read_words_from_txt('results_evaluation_im_fokus.txt')
    words2 = read_words_from_txt('results_individuelles_Verhalten_evaluation.txt')
    words3 = read_words_from_txt(
        'results_Wirbelstürme,Beben,Vulkanausbrüche_evaluation.txt')
