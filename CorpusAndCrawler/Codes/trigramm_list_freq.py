...
with open('/CorpusAndCrawler/BR24/Korpus/Subcorpora/whole_corpus.txt', 'r', encoding='utf-8') as file:
...
with open(f"../BR24/Korpus/lists_with_frequencies/trigram_freq_dist_combined_text_{desired_word}.csv", "w", encoding='utf-8') as csvfile:
