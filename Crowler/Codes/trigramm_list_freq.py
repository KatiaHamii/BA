...
with open('/Crowler/BR24/output/CorpusItself/combined_text.txt', 'r', encoding='utf-8') as file:
...
with open(f"../BR24/output/lists_with_frequencies/trigram_freq_dist_combined_text_{desired_word}.csv", "w", encoding='utf-8') as csvfile:
