...
with open('C:\\Users\\kater\\PycharmProjects\\Bachelorarbeit_v2_fromGIT\\Crowler\\BR24\\output\\CorpusItself\\combined_text.txt', 'r', encoding='utf-8') as file:
...
unrelevant_words = ['br24', 'bearbeiten', 'quelltext', 'tippen', 'einfach', 'schlagwort', 'gibt', 'besonders', 'bisher',
                    ...
                    'abc', 'unterdessen', 'bringen','frau','gelangen', 'dlrg', 'halb','dennoch', 'glaub', 'drauf', 'sollt','beim', 'reiste', 'deswegen',
                    'bloßem', 'euro', 'rasch', 'unnötig'
                    ]
...
viertrigram_list = list(ngrams(cleaned_words, 4))
trigram = [tuple(sorted(list(b))) for b in viertrigram_list]
